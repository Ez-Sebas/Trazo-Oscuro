...
import { existeCorreo, registrarUsuario } from '../utils/authStorage.js'
...
export const RegisterModal = ({ abierto, onCerrar }) => {
    ...
    const validarCampo = (nombre, valor, datosActuales) => {
        ...
        switch (nombre) {
            ...
            case 'correo':
                ...
                if (existeCorreo(valor)) return 'Ya existe una cuenta registrada con este correo.'
                return ''
    ...
    const manejarEnvio = (e) => {
        ...
        registrarUsuario(usuarioAGuardar)
        setRegistrado(true)
    }
            ...
            <div className="bg-superficie rounded-lg w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 sm:p-8 relative">
                ...
                {registrado ? (
                    <div className="text-center py-6">
                        ...
                        <h2 className="text-texto font-serif text-xl sm:text-2xl mb-3">
                            ¡Registro exitoso!
                        </h2>
                        <p className="text-texto-secundario text-sm mb-6">
                            Tu cuenta fue creada correctamente. Ya puedes iniciar sesión.
                        </p>
                        <Button onClick={cerrarYReiniciar}>
                            Ir a iniciar sesión
                        </Button>
                    </div>
                ) : (
                    <>
                        <h2 className="text-texto font-serif text-xl sm:text-2xl mb-1 text-center">
                            Crear cuenta
                        </h2>
